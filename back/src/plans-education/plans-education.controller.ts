...
export class PlansEducationController {
  ...
  @Levels(LEVELS.ADMIN, LEVELS.ALUNO_ESTUDANTE, LEVELS.PROFISSIONAL_EDUCACAO, LEVELS.PROFISSIONAL_SAUDE)
  @Post()
  ...
  @Get(':email')
  findOne(@Param('email') email: string, @Request() request: AuthenticatedRequest,) {

...
describe('PlansEducationController', () => {
  ...
  describe('create', () => {
    ...
    const result =  { id: 1,  created_at: new Date(), updated_at: new Date(), deleted_at: null, ...createPlansEducationDto };
  ...
  describe('findOne', () => {
    it('should return a single plans education by email', async () => {
      ...
      const request = { user: { email: 'test@example.com', id_level: LEVELS.ALUNO_ESTUDANTE } } as any;
      const result = {
            id: 1,
            professor_email: "professor@example.com",
            professor_name: "Professor",

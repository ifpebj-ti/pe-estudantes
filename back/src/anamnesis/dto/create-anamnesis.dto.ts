...
export class CreateAnamnesisDto {
  ...
  @ApiProperty({
    description:
      'Linguagem verbal durante os primeiros trÊs anos de idade em formato JSON',
    example: {
      balbuciou: true,
  ...
  @IsNotEmpty({
    message: 'O campo verbal_language_three_years não deve estar vazio.',
  })
  @IsObject({
    message: 'O campo verbal_language_three_years deve ser um objeto JSON.',
  })
